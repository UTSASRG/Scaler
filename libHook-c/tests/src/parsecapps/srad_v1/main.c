...
int main(int argc, char *argv []){
	...
	image_ori = (fp*)malloc(sizeof(fp) * image_ori_elem); //I

	read_graphics(	"/media/umass/datasystem/steven/benchmark/srad_v1/image.pgm",
								image_ori,
								image_ori_rows,
								image_ori_cols,
								1);
	...
	image = (fp*)malloc(sizeof(fp) * Ne);  //J
    ...
    c  = malloc(sizeof(fp)*Ne) ;							//C							// diffusion coefficient
