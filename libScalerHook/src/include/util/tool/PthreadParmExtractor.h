 ...
 */
inline void parm_pthread_cond_wait(pthread_cond_t ***__cond, pthread_mutex_t ***__mutex, void *rdiLoc, void *rsiLoc) {
    //in edi
    *__cond = (pthread_cond_t **) ((char *) rdiLoc);
 ...
 */
inline void parm_pthread_cond_timedwait(pthread_cond_t ***__cond, pthread_mutex_t ***__mutex, void *rdiLoc, void *rsiLoc) {
    //in edi
    *__cond = (pthread_cond_t **) ((char *) rdiLoc);
    *__mutex = (pthread_mutex_t **) ((char *) rsiLoc);
 ...
 */
inline void parm_pthread_cond_clockwait(pthread_cond_t ***__cond, pthread_mutex_t ***__mutex, void *rdiLoc, void *rsiLoc) {
    //in edi
    *__cond = (pthread_cond_t **) ((char *) rdiLoc);
    *__mutex = (pthread_mutex_t **) ((char *) rsiLoc);
}
