...
DEFINE_WRAPPER(freopen);
DEFINE_WRAPPER(fflush);
DEFINE_WRAPPER(fork);
...
void initializer() {
  INIT_WRAPPER(dlopen, RTLD_NEXT);
  INIT_WRAPPER(accept, RTLD_NEXT);
  INIT_WRAPPER(accept4, RTLD_NEXT);
  ...
  INIT_WRAPPER(freopen, RTLD_NEXT);
  INIT_WRAPPER(fflush, RTLD_NEXT);
  ...
  INIT_WRAPPER(pthread_once, pthread_handle);
  INIT_WRAPPER(pthread_rwlock_init, pthread_handle);
  INIT_WRAPPER(pthread_rwlock_rdlock, pthread_handle);
  INIT_WRAPPER(pthread_rwlock_wrlock, pthread_handle);
  INIT_WRAPPER(pthread_rwlock_unlock, pthread_handle);
  INIT_WRAPPER(pthread_rwlock_destroy, pthread_handle);
