...
#  ARGN - .proto files
#
message("You are using correct FindgRPC")
...
#          ARGS --grpc_out ${DEST} ${protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${ABS_FIL}
#          DEPENDS ${ABS_FIL} protobuf::protoc gRPC::grpc_cpp_plugin
#          COMMENT "Running C++ gRPC compiler on ${FIL}"
#          VERBATIM )
#        #It's hard to use this from different folders, Insead, we execute compile protobuffer at compile time.
##        string(REPLACE ";" " " protobuf_include_path "${_protobuf_include_path}")
##        message("${PROTOBUF_PROTOC_EXECUTABLE} --grpc_out ${DEST} ${protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${ABS_FIL}")
##        execute_process(COMMAND "${PROTOBUF_PROTOC_EXECUTABLE} --grpc_out ${DEST} ${protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${ABS_FIL}"
##                RESULT_VARIABLE rv)
#        if(NOT ${rv} MATCHES 0)
#            message(status "Cannot compile")
#        endif()
#    endforeach ()
#
