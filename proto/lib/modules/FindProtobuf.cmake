...
#  ARGN - .proto files
#
message("You are using correct FindProtobuf")
...
#
#        #    message("Compiling ${FIL} to ${DEST}/${FIL_WE}.pb.cc")
#
#        #    message("${PROTOBUF_PROTOC_EXECUTABLE} --cpp_out ${DEST} ${_protobuf_include_path} ${ABS_FIL}")
#
#        add_custom_command(
#                OUTPUT "${DEST}/${FIL_WE}.pb.cc"
#                "${DEST}/${FIL_WE}.pb.h"
#                COMMAND protobuf::protoc
#                ARGS --cpp_out ${DEST} ${protobuf_include_path} ${ABS_FIL}
#                DEPENDS ${ABS_FIL} protobuf::protoc
#                COMMENT "Running C++ protocol buffer compiler on ${FIL}"
#                VERBATIM)
##        string(REPLACE ";" " " protobuf_include_path "${_protobuf_include_path}")
##        message("${PROTOBUF_PROTOC_EXECUTABLE} --cpp_out ${DEST} ${protobuf_include_path} ${ABS_FIL}")
##        execute_process(COMMAND ${PROTOBUF_PROTOC_EXECUTABLE} --cpp_out ${DEST} ${ABS_FIL}
##        RESULT_VARIABLE rv)
##        if(NOT ${rv} MATCHES 0)
##            message(status "Cannot compile ${rv}")
#        endif()
#    endforeach ()
#
