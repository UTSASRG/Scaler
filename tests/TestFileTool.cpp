...
TEST(FileTool, binarySearch) {
    ...
    char *startAddr = static_cast<char *>(binarySearch(tgt1, 10, kwd1, 3));
    ...
    char kwd2[] = {9, 10, 11};
    startAddr = static_cast<char *>(binarySearch(tgt2, 10, kwd2, 3));
    EXPECT_EQ(startAddr, nullptr);

    char tgt3[] = {1, 2, 3, 4};
    char kwd3[] = {1, 2, 3, 4};
    startAddr = static_cast<char *>(binarySearch(tgt3, 4, kwd3, 4));
